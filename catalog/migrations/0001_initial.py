    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(help_text='Введите категорию', max_length=150, verbose_name='Категория')),
                ('price', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(10000)], verbose_name='Цена за продукт')),
